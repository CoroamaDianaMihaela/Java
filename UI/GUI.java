...
public class GUI {
	...
	public GUI()
	{	
		ImageIcon image1 = new ImageIcon("src/images/dim.png"); 	// setam mai multe obiecte ImageIcon pentru a le pune butoanelor
		ImageIcon image2= new ImageIcon("src/images/dim2r.png");
		ImageIcon image3 = new ImageIcon("src/images/dim3r.png");
		ImageIcon image4 = new ImageIcon("src/images/dim4r.png");
		ImageIcon image5 = new ImageIcon("src/images/dim5r.png");
		ImageIcon image6 = new ImageIcon("src/images/dim6r.png");
		ImageIcon image7 = new ImageIcon("src/images/dim7r.png");
		ImageIcon image8 = new ImageIcon("src/images/dim8r.png");
		...
		ImageIcon icon_2 = new ImageIcon("src/images/money4.png"); 			//setam o imagine pe care sa o folosim pentru label
...
{
	ImageIcon image1 = new ImageIcon("src/images/dim2r.png");
	...
	final JTextArea editTextArea = new JTextArea("");																//creem un component in care se poate scrie in fereastra 
